...
const CartTotal = () => {
   ...
   const {product,delivery_fee,getCartAmount,currency} = useContext(shopDataContext)
  ...
  return (
    ...
    <div className='flex flex-col gap-2 text-sm p-[30px] border-[2px] border-[#4d8890] mt-2'>
